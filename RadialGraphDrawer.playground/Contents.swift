...
let options = GraphOptions(baseOutputURL: baseURL, backgroundColor: .clear, circleColor: appBlue30, arcColor: appBlue, borderColor: .black, circleWidth: 2.0, borderWidthPercent:  0.1)
